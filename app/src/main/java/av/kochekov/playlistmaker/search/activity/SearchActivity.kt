...
import av.kochekov.playlistmaker.player.activity.PlayerActivity
...
import av.kochekov.playlistmaker.search.view_model.SearchViewModel
...
class SearchActivity : AppCompatActivity(), TrackListAdapter.ItemClickListener{
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        viewModel.selectedTrack().observe(this, Observer {
            startActivity(Intent(this, PlayerActivity::class.java).apply {
                putExtra(PlayerActivity.TRACK, it)
            })
        })
    ...
    override fun onItemClick(position: Int, adapter: TrackListAdapter) {
        viewModel.selectTrack(adapter.getData(position))
    }
}